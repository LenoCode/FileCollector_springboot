package com.leno.example.modules.collector.services.collectorService.impl;
...
import com.leno.example.generalServices.process.impl.ContinuesSftpProcess;
...
import com.leno.example.restClients.executionManager.dto.*;
...
public class CollectorServiceImpl implements CollectorServiceInterface {
    ...
    @Value(value = "${sftp.internal.host}")
    private String sftpHost;

    @Value(value = "${hawkdoc.sftp.internal.port}")
    private Integer sftpPort;

    @Value(value = "${sftp.internal.user}")
    private String user;

    @Value(value = "${sftp.internal.password}")
